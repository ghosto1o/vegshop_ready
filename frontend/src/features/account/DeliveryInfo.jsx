  ...
  async function handlePay(o) {
    ...
    try {
      ...
      if (
        ...
        notPayableStatuses.includes(o.status)
      ) {
  ...
  return (
    <div className="container">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
        ...
        {loadingOrders && (
          <span style={{ fontSize: 12, color: '#64748b' }}>กำลังโหลดคำสั่งซื้อ…</span>
        )}
      </div>
      ...
      <div
        ...
        style={{
          ...
          background: '#dcfce7',
          borderRadius: 16,
          boxShadow: '0 10px 28px rgba(22,163,74,.12)',
          marginBottom: 12,
          padding: 14,
        }}
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: '#166534' }}>
              ดูสถานะ • ชำระเงิน • ยกเลิกคำสั่งซื้อ (ถ้ายังไม่กำลังจัดส่ง)
            </div>
          </div>
        </div>
      </div>
          ...
          <tbody>
            {orders.map((o) => (
              <tr key={o._id}>
                ...
                <td>
                  <span style={payChipStyle(o.paymentMethod)}>
                    {renderPayMethod(o.paymentMethod)}
                  </span>
                  {o.chargeId && (
                ...
                <td style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                  ...
                  <button
                    ...
                    disabled={
                      cancellingId === o._id ||
                      ['กำลังจัดส่ง', 'จัดส่งแล้ว', 'ยกเลิก'].includes(o.status)
                    }
