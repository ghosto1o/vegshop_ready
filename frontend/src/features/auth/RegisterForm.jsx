    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        ...
        <div>
          ...
          <div style={{ color: '#166534', fontSize: 13, opacity: 0.9 }}>
            บัญชีใหม่สำหรับสั่งผักได้ทันใจ
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 10 }}>
        ...
        <input
          ...
          onChange={(e) => {
            ...
            console.log('[RegisterForm] name =>', e.target.value)
          }}
        ...
        <input
          ...
          onChange={(e) => {
            ...
            console.log('[RegisterForm] email =>', e.target.value)
          }}
          style={{ background: '#fff' }}
        />
        ...
        <input
          ...
          onChange={(e) => {
            ...
            console.log('[RegisterForm] phone =>', e.target.value)
          }}
          style={{ background: '#fff' }}
        />
        ...
        <div style={{ position: 'relative' }}>
          <input
            ...
            onChange={(e) => {
              ...
              if (e.target.value?.length === 0) console.log('[RegisterForm] password cleared')
            }}
            style={{ background: '#fff' }}
          />
          <button
            ...
            onClick={() => {
              setShowPwd((v) => !v)
              console.log('[RegisterForm] toggle show password =>', !showPwd)
            }}
        ...
        {/* ที่อยู่จัดส่ง */}
        <div style={{ marginTop: 4, fontWeight: 700, color: '#14532d' }}>
          ที่อยู่จัดส่ง (บันทึกทันที)
        </div>
        <input
          className="input"
          ...
          onChange={(e) => {
            ...
            console.log('[RegisterForm] addressLine =>', e.target.value)
          }}
          style={{ background: '#fff' }}
        />
        <input
          ...
          onChange={(e) => {
            ...
            console.log('[RegisterForm] addressPhone =>', e.target.value)
          }}
          style={{ background: '#fff' }}
        />
        <input
          ...
          onChange={(e) => {
            ...
            console.log('[RegisterForm] addressNote =>', e.target.value)
          }}
          style={{ background: '#fff' }}
        />
