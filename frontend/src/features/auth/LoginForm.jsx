      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        ...
        <div>
          ...
          <div style={{ color: '#166534', fontSize: 13, opacity: 0.9 }}>
            ยินดีต้อนรับกลับ สั่งผักได้ทันใจ
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 10 }}>
        ...
        <div style={{ position: 'relative' }}>
          <input
            ...
            onChange={(e) => {
              ...
              if (e.target.value?.length === 0) console.log('[LoginForm] password cleared')
            }}
          ...
          <button
            ...
            onClick={() => {
              setShowPwd((v) => !v)
              console.log('[LoginForm] toggle show password =>', !showPwd)
            }}
        ...
        <button
          ...
          style={{
            ...
            letterSpacing: 0.2,
            background: '#16a34a',
            borderColor: '#16a34a', // ปุ่มสีเดียวกับธีม
          }}
        >
        ...
        >
          <div style={{ fontSize: 12, color: '#166534' }}>
            ยังไม่มีบัญชี? ไปที่แท็บ “สมัครสมาชิก”
          </div>
          <div style={{ fontSize: 12, color: '#166534', opacity: 0.75 }}>
            ต้องการความช่วยเหลือ? ติดต่อผู้ดูแล
          </div>
        </div>
      </form>
    </div>
