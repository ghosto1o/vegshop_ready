...
const products=[
  { name:"คะน้าฮ่องกง", description:"คะน้าอ่อน กรอบหวาน", category:"veg", unit:"กก.", price:55, stock:32, rating:4.6, image:"🥬" },
  { name:"ผักกาดหอม", description:"สดกรอบ พร้อมทาน", category:"veg", unit:"กก.", price:49, stock:24, rating:4.4, image:"🥗" },
  { name:"แตงกวา", description:"แตงกรอบ น้ำเยอะ", category:"veg", unit:"กก.", price:39, stock:50, rating:4.7, image:"🥒" },
  { name:"มะเขือเทศเชอรี่", description:"หวาน สีสด", category:"fruit", unit:"กล่อง", price:65, stock:18, rating:4.8, image:"🍅" },
  { name:"มะม่วงน้ำดอกไม้", description:"หวานหอม เนื้อฉ่ำ", category:"fruit", unit:"กก.", price:89, stock:20, rating:4.7, image:"🥭" },
  { name:"โหระพา", description:"กลิ่นหอม กำใหญ่", category:"herb", unit:"กำ", price:15, stock:100, rating:4.5, image:"🌿" }
]
